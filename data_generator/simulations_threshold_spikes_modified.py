...
if __name__=='__main__':
    ...
    if not os.path.exists('./data/simulated_spike_data_modified'):
        os.mkdir('./data/simulated_spike_data_modified')
    save_data('./data/simulated_spike_data_modified/x_train.pkl', x_train_n)
    save_data('./data/simulated_spike_data_modified/y_train.pkl', y_train)
    save_data('./data/simulated_spike_data_modified/x_test.pkl', x_test_n)
    save_data('./data/simulated_spike_data_modified/y_test.pkl', y_test)
    save_data('./data/simulated_spike_data_modified/thresholds_train.pkl', thresholds_train)
    save_data('./data/simulated_spike_data_modified/thresholds_test.pkl', thresholds_test)
    save_data('./data/simulated_spike_data_modified/gt_train.pkl', gt_importance_train)
    save_data('./data/simulated_spike_data_modified/gt_test.pkl', gt_importance_test)
