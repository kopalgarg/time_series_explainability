...
'''
Generate 3 features, out of which 2 are highly correlated, and 1 is uncorrelated. 

'''

def main(plot,n_samples,  Tt=50):
    signal_in = []
    thresholds = []
    trend_style=[]
    ...
    for i in range(n_train):
        ...
        gt_t_f2= gt_t_f1
        y_vec_f2 = y_vec_f1
        ground_truth_importance_train_f2 = ground_truth_importance_train_f1
    ...
    for i in range(x_test_n.shape[0]):
        ...
        ground_truth_importance_test_f2 = ground_truth_importance_test_f1


    y_train_f0 = np.array(y_train_f0)
    y_train_f1 = np.array(y_train_f1)
    y_train_f2 = np.array(y_train_f1)

    y_test_f0 = np.array(y_test_f0)
    y_test_f1 = np.array(y_test_f1)
    y_test_f2 = np.array(y_test_f1)
    ...
    ground_truth_imp_train_mat[:,2,:] = ground_truth_importance_train_f1

    ground_truth_imp_test_mat[:,0,:] = ground_truth_importance_test_f0
    ground_truth_imp_test_mat[:,1,:] = ground_truth_importance_test_f1
    ground_truth_imp_test_mat[:,2,:] = ground_truth_importance_test_f1
...
def generate_sample(plot, Tt=50):
    trend_style='hill'
